...
numero de verdad (al 2026-08-19, `default: "1.9.0"`). Ese numero es el `X.Y.Z` de
todos los comandos `npx` de abajo.

Si imprime vacio, estas parado en un repo que no es el marco. **No busques el pin
con `grep -rn "@fission-ai/openspec@" .github/`**: en el marco devuelve tres
...
Todo lo que aparezca se completa **en este mismo PR**. En el repo de origen una
