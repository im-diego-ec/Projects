...
Ya paso: el ruleset del repo de origen vivio una semana entera pidiendo el check
...
jobs:
  ...
  marco:
    uses: im-diego-ec/Projects/.github/workflows/marco-ci.yml@v1.7.0
    permissions:
      contents: read
      pull-requests: read
...
**fail-open** y **todo PR corre el CI completo**. En el repo de origen eso duro
...
```yaml
    steps:
      ...
      - uses: im-diego-ec/Projects/actions/censo-fuentes@v1.7.0

      # ... lint, typecheck, tests ...

      # DESPUES de los tests: consume los lcov que las suites acaban de escribir.
      - uses: im-diego-ec/Projects/actions/cobertura-diff@v1.7.0
