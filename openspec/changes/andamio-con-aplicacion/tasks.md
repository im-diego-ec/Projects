...
- [ ] 0.3 **Tomar el snapshot del material de origen**: los 32 archivos del
      starter a un directorio de trabajo, con el `sha256` de cada uno y la fecha.
      El repositorio de origen se va a borrar; sin esta huella no se puede
...
Cada uno se escribe con el material de origen presente en un directorio de
