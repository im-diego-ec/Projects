...
consume una sola vez no ahorra deriva, la traslada al repositorio de origen y le
saca el review.
...
**El hallazgo.** El material de origen tiene `api` y `web`. El `ci.yml` del
...
- **Las versiones de todo lo demás.** React 18, Express 4, Prisma 7, vitest 2,
  Vite 6: son las del material de origen y se absorben como están. Actualizarlas
