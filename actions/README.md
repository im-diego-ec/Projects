...
```yaml
uses: im-diego-ec/Projects/actions/<nombre>@v1.7.0
```
...
jobs:
  openspec:
    ...
    steps:
      ...
      - uses: im-diego-ec/Projects/actions/guardrail-deltas@v1.7.0
```
...
jobs:
  cambios:
    ...
    steps:
      - id: detectar
        uses: im-diego-ec/Projects/actions/carril-docs@v1.7.0
...
jobs:
  aviso:
    ...
    steps:
      - uses: actions/checkout@v7
      - id: mensaje
        uses: im-diego-ec/Projects/actions/aviso-version@v1.7.0
        with:
