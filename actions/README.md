...
```yaml
uses: im-diego-ec/Projects/actions/<nombre>@v1.9.4
```
...
jobs:
  openspec:
    ...
    steps:
      ...
      - uses: im-diego-ec/Projects/actions/guardrail-deltas@v1.9.4
```
...
jobs:
  cambios:
    ...
    steps:
      - id: detectar
        uses: im-diego-ec/Projects/actions/carril-docs@v1.9.4
...
jobs:
  build_test:
    ...
    steps:
      ...
      - uses: im-diego-ec/Projects/actions/censo-fuentes@v1.9.4
```
...
jobs:
  build_test:
    ...
    steps:
      ...
      - uses: im-diego-ec/Projects/actions/cobertura-diff@v1.9.4
```
...
jobs:
  aviso:
    ...
    steps:
      - uses: actions/checkout@v7
      - id: mensaje
        uses: im-diego-ec/Projects/actions/aviso-version@v1.9.4
        with:
