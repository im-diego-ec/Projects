...
```yaml
uses: im-diego-ec/Projects/actions/<nombre>@v1.8.0
```
...
jobs:
  openspec:
    ...
    steps:
      ...
      - uses: im-diego-ec/Projects/actions/guardrail-deltas@v1.8.0
```
...
jobs:
  cambios:
    ...
    steps:
      - id: detectar
        uses: im-diego-ec/Projects/actions/carril-docs@v1.8.0
...
jobs:
  build_test:
    ...
    steps:
      ...
      - uses: im-diego-ec/Projects/actions/censo-fuentes@v1.8.0
```
...
jobs:
  build_test:
    ...
    steps:
      ...
      - uses: im-diego-ec/Projects/actions/cobertura-diff@v1.8.0
```
...
jobs:
  aviso:
    ...
    steps:
      - uses: actions/checkout@v7
      - id: mensaje
        uses: im-diego-ec/Projects/actions/aviso-version@v1.8.0
        with:
