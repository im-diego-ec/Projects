...
No es una idea de escritorio. Projects es la **destilación del estado actual de
[`proyecto-origen`](https://github.com/im-diego-ec/proyecto-origen)**,
un proyecto real que corrió seis semanas en producción (primer commit
2026-07-03) con usuarios internos, incidentes reales y post-mortems escritos.
...
changes archivados del repo de origen:
...
4. **Verificar el nombre del check requerido.** El ruleset del proyecto debe
   ...
   caro de la migración, y ya se cometió una vez: el ruleset del repo de origen
