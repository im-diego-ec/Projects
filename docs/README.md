...
| [arrancar-un-proyecto.md](arrancar-un-proyecto.md) | El paso a paso de **no tener repo** a `ci-ok` verde y el primer change en marcha: las dos piezas (esqueleto de aplicación + andamio del marco), su orden, y los once fallos silenciosos del día 1 | **Canónico** — se actualiza cuando alguien arranca un proyecto y encuentra algo que no está |
