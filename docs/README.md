...
| [10-publicar.md](10-publicar.md) | De `main` en verde a una dirección donde entra la gente: qué sube solo a la copia de prueba y qué publicás vos, la regla de que no se publica lo que no está verde, y el cierre del círculo. **Es el cuarto tramo del camino** | **Canónica** — la fuente del tramo de publicar |
