...
> del tag móvil). Un `git log --oneline docs/12-auditoria-cierre-v1.md` da la fecha de
...
> [07-reglas-no-escritas.md](07-reglas-no-escritas.md), no este archivo.
>
...
11. Exencion NO declarada: Projects usa actions de terceros pinadas por TAG MOVIL dentro del workflow
    ...
    `docs/07-reglas-no-escritas.md` cuenta "Dependabot semanal" entre lo que YA es automatico. La
...
13. `docs/07-reglas-no-escritas.md` esta desactualizado en las dos direcciones a la vez. La fila 10
