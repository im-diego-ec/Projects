...
en proyecto-origen con el pin en `1.4.1`: salida `version 1.3.0, sha
...
[reglas no escritas](../reglas-no-escritas.md)), pero deja de pretender que
...
que [el censo](../censo-de-consumidores.md) ya nombraba. Cada mecanismo hace una
...
| **El pin y el artefacto se mueven juntos, en un PR** | **Nada, todavía** — fila 21 del [backlog](../reglas-no-escritas.md#backlog-de-automatización) |
