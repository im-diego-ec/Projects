...
[reglas no escritas](../10-reglas-no-escritas.md)), pero deja de pretender que
...
que [el censo](../12-censo-de-consumidores.md) ya nombraba. Cada mecanismo hace una
...
| **El pin y el artefacto se mueven juntos, en un PR** | **Nada, todavía** — fila 21 del [backlog](../10-reglas-no-escritas.md#backlog-de-automatización) |
