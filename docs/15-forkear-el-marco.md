...
[11-reglas-no-escritas.md](11-reglas-no-escritas.md), ni commit— de que esto le haya pasado
...
`actions/guardrail-deltas@v1` y `actions/constitucion@v1.9.1`. **Las dos hay que
...
- **El acceso de Dependabot al fork.** Es un ajuste de la **organización** (`Settings
  ...
  [13-censo-de-consumidores.md](13-censo-de-consumidores.md).
